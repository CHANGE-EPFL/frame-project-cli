...
frame --help
```
Hybrid model and component pages on the [FRAME library](https://frame.epfl.ch/) show which command must be run to download and setup specific units. Refer to the full [User guide](user_guide.md) for more details on how to use the CLI tool.
